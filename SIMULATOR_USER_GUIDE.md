...
2. **Visual Feedback:** The first `N` LEDs on the strip light up in that float's signature color (1=Gold/Amber, 2=Red, 3=Green, 4=Cyan, 5=Teal, 6=Pink, 7=Patriotic Blue). The onboard blue LED blinks `N` times in sequence.
