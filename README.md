...
* **Costume Simulation:** Visual browser-based layout engine (`python simulator.py` @ `localhost:8000`) with built-in presets (Pete's Dragon, Cinderella's Coach, Carriage No Horses), Fireworks Starburst cluster generator with serpentine wiring (maintaining 100 LEDs), and authentic runDisney 10K Race Bib (#1952) with Chip & Dale and BibBoards fastener clearance.
